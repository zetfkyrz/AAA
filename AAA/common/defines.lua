...
country = {
	...
	MIN_CRIMEFIGHT_PERCENT = 0.25,
	MAX_CRIMEFIGHT_PERCENT = 0.99,
	ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT = 0.7, -- Crimefight depends on both state admin eff. and admin spending, admin spending percent effect is set to (1-ADMIN_EFFICIENCY_CRIMEFIGHT_PERCENT)
	CONSERVATIVE_INCREASE_AFTER_REFORM = 0.125, -- how many more conservatives in a upper house.
	CAMPAIGN_EVENT_BASE_TIME = 22, -- once every 6 weeks.
	...
	BASE_MONTHLY_DIPLOPOINTS = 0.4, -- Base value gain for diplomatic actions each month
	...
	INVESTMENT_SCORE_FACTOR = 0.05, -- how much foreign investment money counts towards your industry score
...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.25,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.025,	-- how fast pops are Hired when there is a medium demand
...
military = {
	...
	AI_ESCORT_RATIO = 1.5, -- ratio of escorts to transports in invasion fleets
...
pops = {
	...
	MAX_CLERGY_FOR_LITERACY = 0.1, 
	LITERACY_CHANGE_SPEED = 0.125,
...
ai =
{
	...
	CAPITALIST_FRACTION = 0.1, -- max amount of population AI wants to be capis
	...
	CHANCE_INVEST_POP_PROJ = 0.30,
	CHANCE_FOREIGN_INVEST = 0.20,
	...
	FLEET_SIZE = 40, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
	...
	MAX_FLEETS = 6, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
